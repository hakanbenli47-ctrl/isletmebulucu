  ...
  return (
    <section>
      ...
      <div className="search-filters" aria-label="Arama filtreleri">
        ...
        <p>{presenceFilter === "instagram" ? "Yalnızca son iki yılda açıldığı doğrulanan, faal, BTK planına uygun cep telefonlu, Instagram bağlantılı ve bağımsız sitesi olmayan işletmeler getirilir. WhatsApp hesabı mesaj ekranı açılarak ücretsiz doğrulanır." : provinceFilter && sectorFilter ? "Seçilen şehir ve meslekte yalnızca son iki yılda açılan; faal durum, sektör ve BTK mobil numarası doğrulanan işletmeler getirilir. Açık veride WhatsApp işareti olanlar önce gösterilir." : qualityFilter === "selective" ? "Son iki yıllık açılış tarihi, faal kayıt, sektör ve geçerli mobil numara sinyallerinin tamamı zorunludur; WhatsApp sonucu canlı kontrolden sonra kaydedilir." : qualityFilter === "broad" ? "Sektör eşleşmesi genişletilir; son iki yılda açılma, faal durum ve BTK mobil numarası koşulları değişmez. WhatsApp işaretli kayıtlar önce gelir." : "Yalnızca son iki yılda açıldığı açık veride kayıtlı, kapanış işareti olmayan ve BTK numara planına uygun cep telefonlu işletmeler gösterilir. WhatsApp açıkça belirtilenler önce sıralanır; diğerleri mesaj ekranıyla canlı kontrol edilir."}</p>
      </div>
