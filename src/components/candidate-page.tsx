  ...
  return (
    <section>
      ...
      <div className="search-filters" aria-label="Arama filtreleri">
        ...
        <p>{presenceFilter === "instagram" ? "Yalnızca son iki yılda açıldığı doğrulanan, faal, cep telefonlu, Instagram bağlantılı ve bağımsız sitesi olmayan işletmeler getirilir." : provinceFilter && sectorFilter ? "Seçilen şehir ve meslekte yalnızca son iki yılda açılan; faal durum, sektör ve cep telefonu bilgisi doğrulanan işletmeler getirilir." : qualityFilter === "selective" ? "Son iki yıllık açılış tarihi, faal kayıt, sektör ve cep telefonu sinyallerinin tamamı zorunludur." : qualityFilter === "broad" ? "Sektör eşleşmesi genişletilir; son iki yılda açılma, faal durum ve cep telefonu koşulları değişmez." : "Yalnızca son iki yılda açıldığı açık veride kayıtlı, kapanış işareti olmayan ve WhatsApp'a uygun cep telefonlu işletmeler gösterilir."}</p>
      </div>
